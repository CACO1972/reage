  ...
  return (
    <div className="relative z-10 flex min-h-[90vh] flex-col items-center justify-center px-6 text-center">
      ...
      <div className="animate-fade-up mb-8">
        <div className="w-24 h-24 md:w-32 md:h-32 rounded-3xl bg-gradient-to-br from-primary to-accent flex items-center justify-center mx-auto">
          <span className="text-primary-foreground font-bold text-4xl md:text-5xl">S</span>
        </div>
      </div>
      ...
      <div className="animate-fade-up mb-6" style={{ animationDelay: '0.05s' }}>
        <span className="inline-block rounded-full bg-foreground/5 border border-foreground/10 px-5 py-2 text-xs font-medium text-muted-foreground tracking-widest uppercase">
      ...
      {/* Headline */}
      <h1 
        className="animate-fade-up text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-[1.1] tracking-tight font-medium"
        style={{ animationDelay: '0.1s' }}
      >
        <span className="text-foreground">Tu armonia.</span>
        <br />
        <span className="bg-gradient-to-r from-primary via-amber-400 to-primary bg-clip-text text-transparent italic">
          No la de los libros.
        </span>
      </h1>
      ...
      <p className="animate-fade-up mt-6 max-w-lg text-lg md:text-xl text-muted-foreground leading-relaxed" style={{ animationDelay: '0.2s' }}>
        Analisis dentofacial con IA que se adapta a ti, no tu a el.
        <br />
      ...
      <p className="animate-fade-up mt-4 text-sm text-primary font-medium tracking-wide" style={{ animationDelay: '0.25s' }}>
        Para todos. Sin criticas. Sin juicios.
      </p>
      ...
      <div className="animate-fade-up mt-6 flex flex-col items-center gap-2" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <span className="text-xs text-muted-foreground">4.9 de 2,847 analisis</span>
        </div>
      </div>
