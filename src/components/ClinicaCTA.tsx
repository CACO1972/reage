import { Calendar, MapPin, Phone, Mail, Clock, ExternalLink, Percent } from 'lucide-react';
import { motion } from 'framer-motion';

const doctors = [
  {
    name: 'Dra. Camila San Martín',
    link: 'https://ff.healthatom.io/UV2ImT',
  },
  {
    name: 'Dr. Javier Rojas',
    link: 'https://ff.healthatom.io/L4ngYV',
  },
];
      ...
      >
        ...
        <div className="rounded-2xl bg-gradient-to-br from-emerald-500/20 to-emerald-500/5 border border-emerald-500/30 p-6 mb-6">
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-xs text-white/50 mt-1">Incluye Rx Panorámica Digital</p>
          </div>
          ...
          <div className="space-y-2">
            {doctors.map((doctor, index) => (
              <a
                ...
                className="flex items-center justify-between w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 hover:bg-white/10 hover:border-white/20 transition-all group"
              >
